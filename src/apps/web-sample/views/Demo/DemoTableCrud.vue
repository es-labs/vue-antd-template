<template>
  <div>
    ...
    <a-table :columns="table.columns" :data-source="table.data" :pagination="table.pagination" :scroll="table.scroll" :loading="table.loading" size="small" @change="handleTableChange" rowKey="id" :customRow="customRow" :customHeaderRow="customHeaderRow" :row-selection="rowSelection">
      ...
      <a-form layout="vertical" :model="table.formData" :rules="table.formRules">
        <template v-for="(val, col) of table.formData" :key="col">
          <a-form-item :label="table.formConfig[col].title">
            <a-textarea v-if="table.formConfig[col].type === 'textarea'" v-model:value="table.formData[col]" :rows="4" :required="table.formConfig[col].required" :disabled="table.formConfig[col].disabled" />
            <a-input v-else v-model:value="table.formData[col]" :required="table.formConfig[col].required" :disabled="table.formConfig[col].disabled" />
          </a-form-item>
        </template>
        <!--
